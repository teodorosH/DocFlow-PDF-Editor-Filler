...
const I18N = {
  he: {
    ...
    heroSubtitle:
      "הפתרון המהיר והפשוט ביותר למסמכי ה-PDF שלך, בכל שפה ומכל מקלדת!",
    ...
    addTextHint: "הקלד את הטקסט שברצונך למקם במסמך:",
    readOnlyPreview:
      'תצוגה לקריאה בלבד — הורדת הקובץ זמינה רק בכפתור "הורד PDF סופי".',
    selectedElement: "🎯 אלמנט נבחר",
    accountPlanFree: "חינמי",
    guestSponsored: "Sponsored",
    adArea: "[ שטח פרסומת AdSense / Rewarded Ad ]",
    availableIn: "זמין בעוד",
    seconds: "שניות...",
    continueNow: "✅ המשך כעת",
    mobileSignaturePad: "[פד חתימה במגע למובייל]",
    userAlreadyExists: "⚠️ המשתמש כבר קיים",
    userAlreadyExistsHint: "ייתכן שכבר נרשמת עם כתובת המייל הזו.",
    goToLogin: "עבור להתחברות",
    back: "◀ חזרה",
    readOnlyLabel: "קריאה בלבד",
    error: "שגיאה",
    uploadErrorTitle: "שגיאה בטעינת הקובץ",
    uploadError: "לא ניתן לקרוא את קובץ ה-PDF שנבחר.",
    previewError: "אירעה שגיאה ביצירת תצוגה מקדימה",
    downloadSuccessTitle: "הצלחה!",
    downloadSuccess: "הקובץ הורד בהצלחה.",
    downloadError: "אירעה שגיאה בהורדת הקובץ",
    requiredCredentials: "נא למלא מייל וסיסמה",
    loginError: "שגיאה בהתחברות",
    registerError: "שגיאה בהרשמה",
    serverError: "שגיאה בהתחברות לשרת",
    quotaReached: "הגעת למכסת העריכות שלך.",
    quotaTitle: "המכסה הסתיימה ⚠️",
    package10: "רכוש חבילת 10 עריכות ב-₪9.90 🎟️",
    guestPageMessage:
      "משתמשים אורחים יכולים לערוך את עמוד 1 בלבד. הרשם בחינם כדי לערוך את כל עמודי הקובץ!",
    adUploadTitle: "⏳ טוען קובץ PDF...",
    adUploadMessage: "אורח? הרשם בחינם כדי לבטל את זמן ההמתנה בהעלאת קבצים!",
    adPreviewTitle: "👁️ מכין תצוגה מקדימה...",
    adPreviewMessage:
      "אורחים צופים בפרסומת קצרה. הרשמה בחינם תפתח תצוגה מקדימה מיידית!",
    successRegister: "ההרשמה בוצעה בהצלחה! 🚀",
  ...
  en: {
    ...
    heroSubtitle:
      "The fastest and easiest solution for your PDF documents in any language!",
    ...
    guestNotice:
      "Supports all keyboards and languages natively (Hebrew, Arabic, Amharic, Chinese, etc.)",
    ...
    addTextHint: "Enter the text you want to place in the document:",
    readOnlyPreview:
      'Read-only preview — downloading is available only through the "Download PDF" button.',
    selectedElement: "🎯 Selected element",
    accountPlanFree: "Free",
    guestSponsored: "Sponsored",
    adArea: "[ AdSense / Rewarded Ad area ]",
    availableIn: "Available in",
    seconds: "seconds...",
    continueNow: "✅ Continue now",
    mobileSignaturePad: "[Touch signature pad for mobile]",
    userAlreadyExists: "⚠️ User already exists",
    userAlreadyExistsHint:
      "You may already be registered with this email address.",
    goToLogin: "Go to login",
    back: "◀ Back",
    readOnlyLabel: "Read only",
    error: "Error",
    uploadErrorTitle: "File loading error",
    uploadError: "Unable to read the selected PDF file.",
    previewError: "An error occurred while creating the preview",
    downloadSuccessTitle: "Success!",
    downloadSuccess: "The file was downloaded successfully.",
    downloadError: "An error occurred while downloading the file",
    requiredCredentials: "Please enter email and password",
    loginError: "Login error",
    registerError: "Registration error",
    serverError: "Server connection error",
    quotaReached: "You have reached your edit limit.",
    quotaTitle: "Edit limit reached ⚠️",
    package10: "Buy a 10-edit package for ₪9.90 🎟️",
    guestPageMessage:
      "Guest users can edit page 1 only. Register for free to edit all pages!",
    adUploadTitle: "⏳ Loading PDF...",
    adUploadMessage:
      "Guest? Register for free to remove the upload waiting time!",
    adPreviewTitle: "👁️ Preparing preview...",
    adPreviewMessage:
      "Guests watch a short ad. Free registration opens the preview immediately!",
  ...
  ar: {
    ...
    addTextTitle: "✍️ إضافة نص إلى المستند",
    addTextHint: "اكتب النص الذي تريد وضعه في المستند:",
    readOnlyPreview: 'معاينة للقراءة فقط — التنزيل متاح فقط من زر "تحميل PDF".',
    selectedElement: "🎯 العنصر المحدد",
    accountPlanFree: "مجاني",
    guestSponsored: "إعلان",
    adArea: "[ مساحة إعلان ]",
    availableIn: "متاح خلال",
    seconds: "ثوانٍ...",
    continueNow: "✅ متابعة الآن",
    mobileSignaturePad: "[لوحة توقيع باللمس للموبايل]",
    userAlreadyExists: "⚠️ المستخدم موجود بالفعل",
    userAlreadyExistsHint:
      "قد تكون مسجلاً بالفعل باستخدام هذا البريد الإلكتروني.",
    goToLogin: "الانتقال لتسجيل الدخول",
    back: "◀ رجوع",
    readOnlyLabel: "للقراءة فقط",
    error: "خطأ",
    uploadErrorTitle: "خطأ في تحميل الملف",
    uploadError: "تعذر قراءة ملف PDF المحدد.",
    previewError: "حدث خطأ أثناء إنشاء المعاينة",
    downloadSuccessTitle: "نجاح!",
    downloadSuccess: "تم تنزيل الملف بنجاح.",
    downloadError: "حدث خطأ أثناء تنزيل الملف",
    requiredCredentials: "يرجى إدخال البريد الإلكتروني وكلمة المرور",
    loginError: "خطأ في تسجيل الدخول",
    registerError: "خطأ في التسجيل",
    serverError: "خطأ في الاتصال بالخادم",
    quotaReached: "لقد وصلت إلى حد التعديلات.",
    quotaTitle: "انتهى الحد ⚠️",
    package10: "شراء حزمة 10 تعديلات مقابل ₪9.90 🎟️",
    guestPageMessage:
      "يمكن للزوار تعديل الصفحة الأولى فقط. سجل مجاناً لتعديل جميع الصفحات!",
    adUploadTitle: "⏳ جارٍ تحميل ملف PDF...",
    adUploadMessage: "زائر؟ سجل مجاناً لإلغاء وقت الانتظار عند رفع الملفات!",
    adPreviewTitle: "👁️ جارٍ تجهيز المعاينة...",
    adPreviewMessage:
      "يشاهد الزوار إعلاناً قصيراً. التسجيل المجاني يفتح المعاينة فوراً!",
  ...
  am: {
    ...
    wide: "ሰፊ+",
    delete: "🗑️ ሰርዝ",
    addToDocument: "ወደ ሰነዱ ጨምር ✅",
    addTextTitle: "✍️ ጽሑፍ ወደ ሰነዱ ጨምር",
    addTextHint: "በሰነዱ ላይ ማስቀመጥ የሚፈልጉትን ጽሑፍ ያስገቡ:",
    readOnlyPreview: 'ለንባብ ብቻ — ማውረድ የሚቻለው በ"PDF አውርድ" ቁልፍ ብቻ ነው።',
    selectedElement: "🎯 የተመረጠ ኤለመንት",
    accountPlanFree: "ነፃ",
    guestSponsored: "ማስታወቂያ",
    adArea: "[ የማስታወቂያ ቦታ ]",
    availableIn: "ይገኛል በ",
    seconds: "ሰከንዶች...",
    continueNow: "✅ አሁን ቀጥል",
    mobileSignaturePad: "[የሞባይል ንክኪ ፊርማ ፓድ]",
    userAlreadyExists: "⚠️ ተጠቃሚው አለ",
    userAlreadyExistsHint: "በዚህ ኢሜይል አስቀድመው ተመዝግበው ሊሆን ይችላል።",
    goToLogin: "ወደ መግቢያ ሂድ",
    back: "◀ ተመለስ",
    readOnlyLabel: "ለንባብ ብቻ",
    error: "ስህተት",
    uploadErrorTitle: "የፋይል መጫኛ ስህተት",
    uploadError: "የተመረጠውን PDF ማንበብ አልተቻለም።",
    previewError: "ቅድመ እይታ ሲፈጠር ስህተት ተፈጥሯል",
    downloadSuccessTitle: "ተሳክቷል!",
    downloadSuccess: "ፋይሉ በተሳካ ሁኔታ ወርዷል።",
    downloadError: "ፋይሉን ሲያወርዱ ስህተት ተፈጥሯል",
    requiredCredentials: "እባክዎ ኢሜይል እና የይለፍ ቃል ያስገቡ",
    loginError: "የመግቢያ ስህተት",
    registerError: "የምዝገባ ስህተት",
    serverError: "የአገልግሎት ሰርቨር ግንኙነት ስህተት",
    quotaReached: "የአርትዖት ገደብዎ ደርሷል።",
    quotaTitle: "የአርትዖት ገደብ ደርሷል ⚠️",
    package10: "10 አርትዖት ፓኬጅ በ₪9.90 ይግዙ 🎟️",
    guestPageMessage: "እንግዶች ገጽ 1 ብቻ ማስተካከል ይችላሉ። ሁሉንም ገጾች ለማስተካከል በነፃ ይመዝገቡ!",
    adUploadTitle: "⏳ PDF በመጫን ላይ...",
    adUploadMessage: "እንግዳ? የፋይል መጫኛ የመጠበቂያ ጊዜን ለማስወገድ በነፃ ይመዝገቡ!",
    adPreviewTitle: "👁️ ቅድመ እይታ በመዘጋጀት ላይ...",
    adPreviewMessage: "እንግዶች አጭር ማስታወቂያ ያያሉ። ነፃ ምዝገባ ቅድመ እይታን ወዲያውኑ ይከፍታል!",
    successRegister: "ምዝገባው በተሳካ ሁኔታ ተጠናቋል! 🚀",
    successLogin: "መግባት ተሳክቷል! 👋",
    welcome: "እንኳን ደህና መጡ!",
  },
};
  ...
  return (
    <View style={styles.logoContainer}>
      ...
      <Text style={styles.logoText}>
        Doc<Text style={styles.logoHighlight}>Flow</Text>
      </Text>
    </View>
  );
}
...
function _uint8ArrayToBase64(bytes: Uint8Array): string {
  ...
  for (let i = 0; i < len; i += 3) {
    ...
    if (i + 1 >= len) {
      ...
      base64 +=
        BASE64_CHARS.charAt(c1) +
        BASE64_CHARS.charAt(c2) +
        BASE64_CHARS.charAt(c3) +
        "=";
    } else {
      base64 +=
        BASE64_CHARS.charAt(c1) +
...
export default function PdfEditorScreen() {
  ...
  const [pdfDimensions, setPdfDimensions] = useState<PdfDimensions | null>(
    null
  );
  ...
  const [signatureClickPos, setSignatureClickPos] = useState<{
    x: number;
    y: number;
  } | null>(null);
  ...
  const [magnifierSnapshot, setMagnifierSnapshot] = useState<string | null>(
    null
  );
  ...
  const initSignatureCanvas = (canvas: HTMLCanvasElement | null) => {
    ...
    // 1. קריטי למובייל: ביטול מחוות גלילה ברירת מחדל על הקנבס
    canvas.style.touchAction = "none";

    // חישוב קואורדינטות מדויק המתאים גם למחשב וגם למכשירים ניידים
    ...
    // 2. מאזינים ל-Web / העכבר
    canvas.onmousedown = startDrawing as any;
    canvas.onmousemove = draw as any;
    canvas.onmouseup = stopDrawing as any;
    canvas.onmouseleave = stopDrawing as any;

    // 3. מאזינים ייעודיים למגע באנדרואיד (עם passive: false המונע חסימת גלילה)
  ...
  const clearSignatureCanvas = () => {
    ...
    if (Platform.OS === "web" && signatureCanvasRef.current) {
  ...
  const placeSignatureElement = (dataUrl: string) => {
    ...
    const newElement: EditorElement = {
      ...
      x: Math.max(
        0,
        Math.min(1 - widthNorm, signatureClickPos.x - widthNorm / 2)
      ),
      y: Math.max(
        0,
        Math.min(1 - heightNorm, signatureClickPos.y - heightNorm / 2)
      ),
      width: widthNorm,
      height: heightNorm,
  ...
  const saveSignatureAndPlace = () => {
    let finalUri = signatureUri;

    // ב-Web לוקחים את התמונה ישירות מ-canvasRef במידה ואינה ב-State
    if (Platform.OS === "web" && signatureCanvasRef.current) {
      finalUri = signatureCanvasRef.current.toDataURL("image/png");
    }

    if (!finalUri) {
      alert("נא לחתום על הלוח לפני האישור");
      return;
    }

    // יצירת אלמנט החתימה והוספתו לרשימת ה-elements
    const newElement: EditorElement = {
      id: Date.now().toString(),
      type: "signature",
      pageIndex: currentPageIndex,
      x: signatureClickPos?.x ?? 0.3,
      y: signatureClickPos?.y ?? 0.3,
      width: 0.25,
      height: 0.12,
      imageUri: finalUri,
    };
  ...
  const pickDocument = async () => {
    if (!currentUser) {
      triggerAd(5, t.adUploadTitle, t.adUploadMessage, "upload");
    } else {
      processDocumentUpload();
    }
  };
  ...
  const handlePreviewPdf = () => {
    ...
    if (!currentUser) {
      triggerAd(10, t.adPreviewTitle, t.adPreviewMessage, "preview");
    } else {
      executePreviewProcess();
    }
  };
  ...
  const executePreviewProcess = async () => {
    setLoading(true);
    try {
      const bytes = await buildModifiedPdfBytes(pdfBytes, elements);
      ...
      console.error("Preview trigger error:", e);
    } finally {
      setLoading(false);
    }
  };
      ...
      try {
        ...
        if (!res.ok) {
          if (Platform.OS === "web") {
            ...
            Alert.alert(t.quotaTitle, data.error || t.quotaReached, [
              { text: "סגור" },
  ...
  const handleAuthStep1 = async () => {
    ...
    if (authMode === "register") {
      ...
      try {
        ...
        const displayName =
          data.user.fullName || data.user.full_name || data.user.email;
        const serverLanguage =
          data.user?.language ||
          data.user?.preferredLanguage ||
          data.user?.preferred_language;
        const resolvedLanguage: Language = ["he", "en", "ar", "am"].includes(
          serverLanguage
        )
          ? serverLanguage
          : authLanguage;
  ...
  const handleAuthSubmit = async () => {
    ...
    try {
      ...
      setAuthStep(1);
      if (Platform.OS === "web")
        alert(authMode === "register" ? t.successRegister : t.successLogin);
      else
        Alert.alert(
          authMode === "register" ? t.successRegister : t.successLogin,
          authMode === "register" ? t.successRegister : t.successLogin
        );
    } catch (err: any) {
      ...
      prev.map((el) => {
        ...
        if (updates.width !== undefined) {
          ...
          updated.width = Math.max(
            MIN_WIDTH,
            Math.min(MAX_WIDTH, updates.width)
          );
        }
  ...
  const nudgeSelected = (dx: number, dy: number) => {
    ...
    const newX = Math.max(
      0,
      Math.min(1 - selectedElement.width, selectedElement.x + nx)
    );
    const newY = Math.max(
      0,
      Math.min(1 - selectedElement.height, selectedElement.y + ny)
    );
    updateElementProps(selectedElement.id, { x: newX, y: newY });
  };

  // פונקציה להורדת קבצים בינאריים שעובדת 100% בכל גרסאות React Native / Expo ללא ספריות חיצוניות
  const fetchBinaryData = (url: string): Promise<ArrayBuffer> => {
    return new Promise((resolve, reject) => {
      ...
      xhr.onload = () => {
        if (xhr.status >= 200 && xhr.status < 300) {
          ...
          reject(new Error(`Failed to load binary data: ${xhr.status}`));
        }
      };
      xhr.onerror = () =>
        reject(new Error("Network error during binary fetch"));
      xhr.send();
    });
  };
    ...
    return (
      <View style={styles.paginationRow}>
        ...
        <View style={styles.pageBadgeTextContainer}>
          <Text style={styles.pageIndicatorText}>
            {t.pageOf
              ...
              .replace("{total}", numPages.toString())}
        ...
        <TouchableOpacity
          style={[
            styles.pageBtn,
            (currentPageIndex === numPages - 1 || !currentUser) &&
              styles.disabledBtn,
          ]}
          onPress={() =>
            handlePageChange(Math.min(numPages - 1, currentPageIndex + 1))
          }
        >
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <View style={[styles.headerBar, { maxWidth: BASE_CONTAINER_WIDTH }]}>
            ...
            {currentUser ? (
              ...
              <View style={styles.guestHeaderActionsV1}>
                ...
                >
                  <Text style={styles.authTriggerBtnTextV1}>
                    {t.loginRegister}
                  </Text>
                </TouchableOpacity>
                <View style={styles.langBar}>
                  {(["he", "en", "ar", "am"] as Language[]).map((l) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.langBtn,
                        lang === l && styles.activeLangBtn,
                      ]}
                    >
                      <Text
                        style={[
                          styles.langText,
                          lang === l && styles.activeLangText,
                        ]}
                      >
                        {l === "he"
                          ? "עב"
          ...
          {!pdfUri ? (
            ...
            <View
              style={[styles.editorArea, { maxWidth: BASE_CONTAINER_WIDTH }]}
            >
              <TouchableOpacity
              ...
              <View style={styles.toolbarRow}>
                ...
                >
                  <Text
                    style={[
                      styles.toolBtnText,
                      activeTool === "text" && styles.activeToolBtnText,
                    ]}
                  >
                    {t.textTool}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.toolBtn,
                    activeTool === "signature" && styles.activeToolBtn,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.toolBtnText,
                      activeTool === "signature" && styles.activeToolBtnText,
                    ]}
                  >
                    {t.signatureTool}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.toolBtn,
                    activeTool === "highlight" && styles.activeToolBtn,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.toolBtnText,
                      activeTool === "highlight" && styles.activeToolBtnText,
                    ]}
                  >
                    {t.highlightTool}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.toolBtn,
                    activeTool === "redact" && styles.activeToolBtn,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.toolBtnText,
                      activeTool === "redact" && styles.activeToolBtnText,
                    ]}
                  >
                    {t.redactTool}
                  </Text>
                ...
                <TouchableOpacity
                  style={[
                    styles.toolBtn,
                    activeTool === "magnifier" && styles.activeToolBtn,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.toolBtnText,
                      activeTool === "magnifier" && styles.activeToolBtnText,
                    ]}
                  >
                    {t.magnifierTool}
                  </Text>
              ...
              <View style={styles.zoomControlRow}>
                ...
                <View style={styles.fontDefaultControl}>
                  <TouchableOpacity
                    onPress={() =>
                      setDefaultFontSize((prev) => Math.max(10, prev - 2))
                    }
                  >
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      setDefaultFontSize((prev) => Math.min(40, prev + 2))
                    }
                  >
                    <Text style={styles.fontBtnText}>A+</Text>
                  </TouchableOpacity>
                  ...
                  <View style={styles.dockControlsRow}>
                    ...
                    {selectedElement.type === "text" ? (
                      <View style={styles.dockGroup}>
                        ...
                        <Text style={styles.fontSizeBadge}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        setElements((prev) =>
                          prev.filter((e) => e.id !== selectedElement.id)
                        );
                        setSelectedElementId(null);
                      }}
                    >
              ...
              >
                <View
                  style={[
                    ...
                    { width: CONTAINER_WIDTH, height: containerHeight },
                  ]}
                >
                  {Platform.OS === "web" ? (
                    <canvas
                      ...
                      <WebView
                        ...
                        onMessage={(event) => {
                          try {
                            ...
                            if (data.type === "click") {
                              // אם זכוכית המגדלת פעילה - עדכן את תמונת ה-Snapshot ואת המיקום
                              if (activeTool === "magnifier") {
                                if (data.snapshot) {
                                  setMagnifierSnapshot(data.snapshot);
                                }
                                const relX = data.x / data.containerWidth;
                                const relY = data.y / data.containerHeight;
                            ...
                            <html>
                              ...
                              <body>
                                ...
                                <script>
                                  ...
                                  const base64Data = "${_uint8ArrayToBase64(
                                  ...
                                  document.getElementById('canvas-container').addEventListener('click', function(e) {
                                    ...
                                    // חילוץ תמונת הקנבס עבור זכוכית המגדלת
                                    const canvas = document.getElementById('pdf-canvas');
                                    let snapshot = null;
                                    if (canvas) {
                                      try {
                  ...
                  {activeTool === "magnifier" && magnifierPos && (
                    <View
                      pointerEvents="box-none"
                      style={{
                        position: "absolute",
                        left: Math.min(
                          Math.max(10, magnifierPos.x * CONTAINER_WIDTH - 160),
                          Math.max(10, CONTAINER_WIDTH - 330)
                        ),
                        top: Math.min(
                          Math.max(10, magnifierPos.y * containerHeight - 85),
                          Math.max(10, containerHeight - 180)
                        ),
                        width: 320,
                        height: 170,
                        overflow: "hidden",
                      ...
                      {magnifierSnapshot ? (
                        <Image
                          ...
                          style={{
                            position: "absolute",
                            left: -(
                              magnifierPos.x * CONTAINER_WIDTH * magZoom -
                              160
                            ),
                            top: -(
                              magnifierPos.y * containerHeight * magZoom -
                              85
                            ),
          ...
          <Modal visible={showSignatureModal} transparent animationType="fade">
            <View style={styles.modalOverlay}>
              <View style={[styles.modalCard, { maxWidth: 450 }]}>
                ...
                <TouchableOpacity
                  style={styles.uploadSigFileBtn}
                  onPress={handleUploadSignatureImage}
                >
                  <Text style={styles.uploadSigFileBtnText}>
                    {t.uploadSigImage}
                  </Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  {Platform.OS === "web" ? (
                    ...
                    >
                      <canvas
                        ref={(canvas) => initSignatureCanvas(canvas)}
                        width={320}
                        height={160}
                        style={{
                          width: "100%",
                    ...
                    /* 📱 תצוגה באנדרואיד / מובייל (WebView) */
                    <View
                      style={{
                        width: 320,
                        height: 160,
                    ...
                    >
                      <WebView
                        ...
                        onMessage={(event) => {
                          try {
                            const data = JSON.parse(event.nativeEvent.data);
                            if (data.type === "signature" && data.uri) {
                              setSignatureUri(data.uri); // ✅ עדכון ה-State של החתימה
                            }
                          } catch (e) {
                            console.error("Signature WebView Error:", e);
                          }
                        }}
                        source={{
                          html: `
                            ...
                            <body>
                              ...
                              <script>
                                ...
                                function stop(e) {
                                  ...
                                  if (window.ReactNativeWebView) {
                                    window.ReactNativeWebView.postMessage(JSON.stringify({ type: 'signature', uri: dataUrl }));
                                  }
                                }
                ...
                >
                  ...
                  <TouchableOpacity
                    style={[
                      styles.actionBtn,
                      { backgroundColor: "#16a34a", flex: 2 },
                    ]}
                    onPress={saveSignatureAndPlace}
                  >
                    <Text
                      style={{
                        color: "#fff",
                ...
                {!isAdFinished ? (
                  <View style={styles.timerBox}>
                    ...
                    <Text style={styles.timerText}>
                      {t.availableIn}{" "}
                      <Text style={styles.timerCount}>{adTimer}</Text>{" "}
                      {t.seconds}
                    </Text>
                  </View>
                ) : (
                  <TouchableOpacity
                    ...
                    onPress={handleAdFinishedAction}
                  >
          ...
          <Modal
            visible={showAccountModal && !!currentUser}
            transparent
            animationType="fade"
            ...
            <View style={styles.modalOverlay}>
              <View style={styles.accountModalV1}>
                <View style={styles.accountModalHeaderV1}>
                  <View>
                    <Text style={styles.accountModalTitleV1}>
                      👤 {t.personalArea}
                    </Text>
                  ...
                  <TouchableOpacity
                    style={styles.accountModalCloseIconV1}
                ...
                <View style={styles.accountInfoBoxV1}>
                  <Text style={styles.accountInfoLabelV1}>
                    {t.accountEmail}
                  </Text>
                  <Text style={styles.accountInfoValueV1}>
                    {currentUser?.email}
                  </Text>
                  <Text style={[styles.accountInfoLabelV1, { marginTop: 8 }]}>
                    {t.accountPlan}
                  </Text>
                  <Text style={styles.accountInfoValueV1}>
                    {currentUser?.plan === "free"
                      ? t.accountPlanFree
                      : currentUser?.plan || t.accountPlanFree}
                  </Text>
                </View>

                <View style={styles.accountLanguageSectionV1}>
                  <Text style={styles.accountLanguageTitleV1}>
                    🌐 {t.changeLanguage}
                  </Text>
                  <View style={styles.accountLanguageRowV1}>
                    {(["he", "en", "ar", "am"] as Language[]).map((l) => (
                      <TouchableOpacity
                        key={l}
                        style={[
                          styles.accountLanguageBtnV1,
                          lang === l && styles.accountLanguageBtnActiveV1,
                        ]}
                        onPress={() => {
                          setAppLanguage(l);
                          setAuthLanguage(l);
                          setCurrentUser((prev) =>
                            prev
                              ? { ...prev, language: l, preferredLanguage: l }
                              : prev
                          );
                        }}
                      >
                        <Text
                          style={[
                            styles.accountLanguageTextV1,
                            lang === l && styles.accountLanguageTextActiveV1,
                          ]}
                        >
                          {l === "he"
                            ? "עברית"
                ...
                <TouchableOpacity
                  style={styles.accountCloseBtnV1}
                  onPress={() => setShowAccountModal(false)}
                >
              ...
              <View style={styles.authModalV1}>
                ...
                {authStep === 1 ? (
                  <View style={{ width: "100%" }}>
                    ...
                    {authMode === "register" && (
                      <View style={styles.authLanguageSectionV1}>
                        <Text style={styles.authLanguageLabelV1}>
                          {t.accountLanguageLabel}
                        </Text>
                        <View style={styles.authLanguageRowV1}>
                          {(["he", "en", "ar", "am"] as Language[]).map((l) => (
                            <TouchableOpacity
                              key={l}
                              style={[
                                styles.authLanguageBtnV1,
                                authLanguage === l &&
                                  styles.authLanguageBtnActiveV1,
                              ]}
                              onPress={() => {
                                setAuthLanguage(l);
                                setAppLanguage(l);
                            ...
                            >
                              <Text
                                style={[
                                  styles.authLanguageTextV1,
                                  authLanguage === l &&
                                    styles.authLanguageTextActiveV1,
                                ]}
                              >
                                {l === "he"
                                  ? "עברית"
                    ...
                    {userAlreadyExistsError && (
                      <View style={styles.userExistsWarningBox}>
                        ...
                        >
                          <Text style={styles.switchLoginBtnText}>
                            {t.goToLogin}
                          </Text>
                        </TouchableOpacity>
                      </View>
                    ...
                    {authMode === "register" ? (
                      <TouchableOpacity
                        style={styles.primaryButtonWideV1}
                        onPress={handleAuthStep1}
                      >
                  ...
                  <View style={{ width: "100%", alignItems: "center" }}>
                    <Text style={styles.authSectionTitleV1}>
                      {t.selectPlanTitle}
                    </Text>
                    <View style={styles.plansRowV1}>
                      <TouchableOpacity
                        style={[
                          styles.planCardV1,
                          selectedPlan === "free" && styles.planCardActiveV1,
                        ]}
                      ...
                      <TouchableOpacity
                        style={[
                          styles.planCardV1,
                          selectedPlan === "micro_pass" &&
                            styles.planCardActiveV1,
                        ]}
                      ...
                      <TouchableOpacity
                        style={[
                          styles.planCardV1,
                          selectedPlan === "premium" && styles.planCardActiveV1,
                        ]}
                        onPress={() => setSelectedPlan("premium")}
                      >
                        <Text style={styles.planTitleV1}>{t.premiumPlan}</Text>
                        <Text style={styles.planDescV1}>
                          {t.premiumPlanDesc}
                        </Text>
                      </TouchableOpacity>
                    </View>
              ...
              <View style={{ flex: 1, backgroundColor: "#525659" }}>
                {previewPdfBytes ? (
                  Platform.OS === "web" ? (
                    ...
                    /* רינדור בטוח ב-Android/iOS באמצעות PDF.js בתוך WebView */
                    <WebView
                      originWhitelist={["*"]}
                      allowFileAccess={true}
                      style={{ flex: 1 }}
                          ...
                          <head>
                            ...
                            <style>
                              * { margin: 0; padding: 0; box-sizing: border-box; }
                              body { background-color: #525659; display: flex; flex-direction: column; align-items: center; padding: 10px; min-height: 100vh; }
                              canvas { box-shadow: 0 4px 10px rgba(0,0,0,0.3); max-width: 100%; height: auto !important; margin-bottom: 10px; background: white; }
                            </style>
                          </head>
                          <body>
                            <div id="pdf-container"></div>
                            <script>
                              const pdfData = "${_uint8ArrayToBase64(
                                previewPdfBytes
                              )}";
                              ...
                              pdfjsLib.getDocument({ data: uint8Array }).promise.then(pdf => {
                                ...
                                // רינדור כל העמודים או העמוד הנוכחי
                                ...
                                document.body.innerHTML = '<div style="color:white;padding:20px;">שגיאה בטעינת התצוגה המקדימה</div>';
                              });
                            </script>
                          </body>
                          </html>
        ...
        const newX = Math.max(
          ...
          Math.min(
            ...
            (dragRef.current?.startX ?? current.x) +
              gestureState.dx / containerBounds.width
          )
        );
        const newY = Math.max(
          0,
          Math.min(
            ...
            (dragRef.current?.startY ?? current.y) +
              gestureState.dy / containerBounds.height
          )
        );
        onUpdatePos(current.id, newX, newY);
      },
  ...
  const content = (
    <>
      ...
      {element.type === "highlight" && (
        <View
          style={[styles.highlightBox, { width: "100%", height: "100%" }]}
        />
      )}
      {element.type === "redact" && (
        <View style={[styles.redactBox, { width: "100%", height: "100%" }]} />
      )}
    </>
  );
...
const renderCrispTextToCanvas = async (
  text: string,
  fontSize: number
): Promise<{ base64Png: string; width: number; height: number } | null> => {
  ...
  try {
    ...
    const fontStack = `${scaledFontSize}px Arial, sans-serif`;
    ...
    console.warn("Canvas text render warning:", err);
    return null;
  }
};
...
const styles = StyleSheet.create({
  ...
  accountLanguageRowV1: {
    flexDirection: "row",
    flexWrap: "wrap",
    justifyContent: "center",
    gap: 6,
  },
  accountLanguageBtnV1: {
    paddingVertical: 7,
    paddingHorizontal: 10,
    borderRadius: 7,
    backgroundColor: "#fff",
